...
if (!file_exists(GLPI_CONFIG_DIR . "/config_db.php")) {
   ...
   echo '<head><title>'.__('Segurtex - Soporte').'</title>'."\n";
...
//          "</script>";
   ...
   echo "<a href='http://localhost/glpi' title='SEGURTEX'>";
   /*echo 'GLPI version '.(isset($CFG_GLPI["version"])?$CFG_GLPI["version"]:"").
        ' Copyright (C) 2003-'.date("Y").' SEGURTEX';*/
   echo 'SEGURTEX - OUTSOURCING INFORMATICO';
   echo "</a></div>";
