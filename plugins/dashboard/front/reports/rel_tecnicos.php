...
//fim while	
		...
		echo "
		<tr>
			<td style='vertical-align:middle; text-align:left;'><i class='del fa fa-times' style='cursor:pointer;' title='". __('Hide') ."'>&nbsp;&nbsp;&nbsp; </i><a href=".$CFG_GLPI['root_doc']."/front/user.form.php?id=". $id_tec['id'] ." target=_blank >" . $id_tec['fname'].' '.$id_tec['rname']. ' ('.$id_tec['id'].")</a></td>
