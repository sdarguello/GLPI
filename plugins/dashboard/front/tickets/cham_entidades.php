...
<div id="lista_chamados" class="well info_box row-fluid report" style="width:95%;">	
		...
		if(isset($_REQUEST['order'])) {
			...
			switch($order1) {
				 ...
				 case "tecd": $order = "ORDER BY name DESC"; break;
				 case "teca": $order = "ORDER BY name ASC"; break;	
...
echo "<table id='tickets' class='display' style='font-size: 20px; font-weight:bold;' cellpadding = 2px >				
		...
		//<th style='text-align:center;'><a href='chamados.php?order=tia'>&nbsp<font size=2.5pt; font-family='webdings'>&#x25BE;&nbsp;</font></a>". __('Title')."<a href='chamados.php?order=tid'><font size=2.5pt; font-family='webdings'>&nbsp;&#x25B4;</font></a></th>
		//<th style='text-align:center;'><a href='chamados.php?order=teca'>&nbsp<font size=2.5pt; font-family='webdings'>&#x25BE;&nbsp;</font></a>". __('Technician')."<a href='chamados.php?order=tecd'><font size=2.5pt; font-family='webdings'>&nbsp;&#x25B4;</font></a></th>
