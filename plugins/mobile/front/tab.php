...
while($row = $DB->fetch_assoc($result_fup)) {
	...
	$sql_autor = "SELECT glpi_users.firstname AS name, glpi_users.realname AS sname
...
//http://192.168.1.118/sos-084/front/document.send.php?docid=127&tickets_id=15949
...
//item.php?itemtype=Computer&menu=inventory&ssmenu=computer&id=795	
//http://10.20.12.107/glpi/plugins/mobile/front/item.php?itemtype=Ticket&menu=maintain&ssmenu=ticket&id=14756
//http://10.20.12.107/glpi/plugins/mobile/front/item.php?itemtype=user&menu=admin&ssmenu=user&id=889
