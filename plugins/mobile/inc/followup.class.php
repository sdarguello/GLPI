...
class PluginMobileFollowup  {
   ...
   public static function show($ID,$from_followup) {
      ...
      if (!Session::haveRight("global_add_followups","1")) {
          return false;
      }
...
//header('Location: '.$CFG_GLPI["root_doc"].'plugins/mobile/inc/item.php?itemtype=Ticket&menu=maintain&ssmenu=ticket&id='.$_REQUEST['id']);
