...
$acha = preg_match('/notifica.php/', $string, $matches );
      ...
      if($acha === 0) {
			...
			echo "<br><p><span>" .__('Before you enable Clone plugin make sure your file <b>inc/html.class.php</b> is owned by apache user, usually www-data or wwwrun','webnotifications')."</span>";
				}
		else { 
